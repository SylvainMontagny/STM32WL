...
//#define USE_DMA
//#define USE_IT // Edit by Sacha

/* If u need CS control, comment below*/
//#define CFG_NO_CS

/* Pin connection*/
#define ST7789_RST_PORT GPIOB //ST7789_RST_GPIO_Port
#define ST7789_RST_PIN  GPIO_PIN_2 //ST7789_RST_Pin
#define ST7789_DC_PORT  GPIOB //ST7789_DC_GPIO_Port
...
#define LCD_BRED 		0x07E0
#define LCD_GRED 		0x001F
#define LCD_GBLUE 		0xF800
#define LCD_BROWN 		0x43BF
#define LCD_BRRED 		0x03F8
#define LCD_DARKBLUE 	0xFE30
#define LCD_LIGHTBLUE 	0x8283
#define LCD_GRAYBLUE 	0xABA7

#define LCD_LIGHTGREEN 	0x7BE0
#define LCD_LGRAY 		0x39E7
